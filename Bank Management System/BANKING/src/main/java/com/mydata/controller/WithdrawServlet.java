...
public class WithdrawServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         List<Register>r= rd.Withdraw(accno, ifsc);
           ...
           int x=rd.Withdraw1(accno, ifsc, amt2);
           
          
        	   out.print("Withdraw succcessfully!!!!!!");
        	  ...
        	  // request.setAttribute("value","invalid");
			   request.getRequestDispatcher("Withdraw.jsp?value=invalid").include(request, response);
